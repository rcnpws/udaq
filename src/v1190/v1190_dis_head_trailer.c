...
int main(int argc, char *argv[]){
  ...
  if(argc>1 && !strcmp(argv[1],"-h")){
    fprintf(stderr, "%s ... set v1190 to disable TDC header and TRAILER.\n", argv[0]);
  ...
  fprintf(stderr, "micro code write: V1190_OPECODE_DIS_HEAD_TRAILER\n");
  ret = v1190_micro_handshake_write(v1190, V1190_OPECODE_DIS_HEAD_TRAILER);
  if(ret!=0){
