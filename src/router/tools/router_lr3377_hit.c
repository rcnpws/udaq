/*
	router_lr3377_hit.c ... Show LR3377 Hits in the data from a router
  Copyright (C) 1996  A. Tamii
  Author:   A. Tamii
	Facility: Department of Physics, Kyoto University 
	          & Research Center for Nuclear Physics
  Created:  02-JUN-1996 by A. Tamii (for Solaris 2.3)
*/
		 ...
		 char   *argv[];
{
	...
	if(argc<2 || argc>1 && !strcmp(argv[1],"-h")){
		fprintf(stderr, "%s ... show lr3377 hits in the data from a router\n",
						argv[0]);
