/*
  ...
  Modified: 03-JUN-2017 by A. Tamii (for EASIROC and ID_EXT)
*/
...
# define	ID_TDC         (0x04<<12) /* disposed */
# define	ID_MYRIAD      (0x04<<12)
# define        ID_3351        (0x05<<12) /* disposed */
# define        ID_EXT         (0x05<<12) /* extension */
...
/*** Module IDs (extension) ***/
# define        ID_EXT_None        0x0000
# define        ID_EXT_EASIROC     0x0100
# define	ID_EXT_Module_Mask 0xFF00
