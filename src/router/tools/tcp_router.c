/*
  ...
  Created:  18-FEB-1995 by A. Tamii (for Solaris 2.3) 
            ...
            09-NOV-2014 ver 3.0  by A. Tamii   (Do not break when read size is zero)
*/
...
static char title[] = "TCP Router Ver 3.1 09-NOV-2014";
#if 0
static char title[] = "TCP Router Ver 3.0 14-JUL-2014";
  ...
  ptr  = (char*)&info2;
	...
	for(i=1;;i++){
      ...
      if(count>bufsize){
				...
				usleep(10);  // 2014.11.09 (do not break)
			}
