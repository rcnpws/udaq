...
int main(int argc, char *argv[]){
  ...
  /* default values */
  int irq_threshold = MADC32_IRQ_THRESHOLD_DEFAULT;
  int multi_event = MADC32_MULTI_EVENT_YES_UNLIMITED;
  //  int marking_type = MADC32_MARKING_TYPE_EVENT_COUNTER;
  int marking_type = MADC32_MARKING_TYPE_TIME_STAMP; /* changed on 16/04/12 for fast clear */
  ...
  madc32->ts_sources = MADC32_TS_SOURCES_EXT;
