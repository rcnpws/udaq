...
/*** message queue ***/
#define RTR_MNOSENDMSG 100        /* max number of messages in the queue */

/*** shared memory ***/
#define RTR_DEF_SHMSIZE    (0x4000*64)
                               /* size of the shared memroy (default_)*/
#define RTR_MAXSAMPBUF     2   /* max number of buffers can be sent to sampling
																		 readers at once */
#define RTR_MAXSENDBUF    12   /* max number of buffers can be sent to must
																		 readers */
#define RTR_MAXWRITEBUF    3   /* max number of buffers can be sent to
																		 writers */

#define RTR_ALARM_TIME     1   /* timeout of msgrcv in sec */
#define RTR_TMO           60   /* No response timeout (in sec) */

#define  WAITMSG           1   /* show message of pending */
