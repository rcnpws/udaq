...
#define MADC32_IRQ_THRESHOLD_DEFAULT 6000     /* IRQ Threshold max=8120  */
...
#define MADC32_TS_SOURCES_VME                    0  /* source:external, disable external reset */  
#define MADC32_TS_SOURCES_EXT                    1  /* source:external, disable external reset */  
#define MADC32_TS_SOURCES_EXTERNAL_RESET         2  /* bit for enabling the external reset */  
...
#define MADC32_SUBHEADER_NO_HEADER           0x0001
#define MADC32_SUBHEADER_NO_END_OF_EVENT     0x0002
